...
-git init
-git remote add origin (link repo contoh: git remote add origin https://github.com/oodikxeonz/Baherindo-Motor-git)
-git branch -M main
...
-Clone Repository: git clone https://github.com/oodikxeonz/Baherindo-Motor
