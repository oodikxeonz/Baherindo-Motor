...
function openPopup(type) {
    ...
    if (type === 'whatsapp') {
        ...
        confirmBtn.href = "https://wa.me/6287797895571?text=Halo,%20saya%20tertarik%20dengan%20{{ urlencode($motor->nama_motor) }}";
    } 
    else if (type === 'delete') {
        title.textContent = 'Hapus Motor';
        message.textContent = 'Yakin ingin menghapus motor ini? Tindakan ini tidak bisa dibatalkan.';
        confirmBtn.href = "{{ route('motor.destroy', $motor->id) }}";
